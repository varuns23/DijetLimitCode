...
const char* PAR_NAMES[NPARS]    = { "xs", "lumi", "jes", "jer", "eff",  "bkg norm",        "p1",        "p2",         "p3", "n0", "n1", "n2", "n3" };
      double PAR_GUESSES[NPARS] = {  0.1,  4976.,   1.0,   1.0,   0.4, 1.13753e-01, 8.15848e+00, 5.68451e+00,  1.17281e-01,   10,   10,   10,   10 };
...
int main(int argc, char* argv[])
{
  ...
  // input file names
  INPUTFILES.push_back("Data_and_ResonanceShapes/Final__histograms_TCHEL_1Tag_WideJets.root");
