...
const char* PAR_NAMES[NPARS]    = { "xs", "lumi", "jes", "jer", "eff",  "bkg norm",        "p1",        "p2",         "p3", "n0", "n1", "n2", "n3" };
      double PAR_GUESSES[NPARS] = { 1E-5,  4976.,   1.0,   1.0,   0.1, 2.28255e-01, 8.51130e+00, 5.42168e+00,  5.23767e-02,   10,   10,   10,   10 };
...
const double PAR_MAX[NPARS]     = { 1.E6,  6000.,   2.0,   2.0,   1.0,        9999,        9999,        9999,         9999,   11,   11,   11,   11 };
      double PAR_ERR[NPARS]     = { 1E-3,   110.,  0.03,  0.10,  0.05,      1e-02,        1e-01,       1e-01,        1e-02,    1,    1,    1,    1 };
