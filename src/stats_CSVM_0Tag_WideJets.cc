...
const char* PAR_NAMES[NPARS]    = { "xs", "lumi", "jes", "jer", "eff",  "bkg norm",        "p1",        "p2",         "p3", "n0", "n1", "n2", "n3" };
      double PAR_GUESSES[NPARS] = {  0.1,  4976.,   1.0,   1.0,   0.5, 4.11820e-01, 8.73427e+00, 5.14178e+00, -1.06130e-03,   10,   10,   10,   10 };
...
const double PAR_MAX[NPARS]     = { 1.E6,  6000.,   2.0,   2.0,   1.0,        9999,        9999,        9999,         9999,   11,   11,   11,   11 };
      double PAR_ERR[NPARS]     = { 0.01,   110.,  0.03,  0.10,  0.05,      1e-02,        1e-01,       1e-01,        1e-02,    1,    1,    1,    1 };
...
int main(int argc, char* argv[])
{
  ...
  HISTCDF=getSignalCDF(filename1.c_str(), histname1.str().c_str(), filename2.c_str(), histname2.str().c_str(), BR, g_eff0_h->Eval(SIGMASS), g_eff0_l->Eval(SIGMASS));
