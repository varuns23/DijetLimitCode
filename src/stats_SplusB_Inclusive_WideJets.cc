...
const char* PAR_NAMES[NPARS]    = { "xs", "lumi", "jes", "jer",  "bkg norm",        "p1",        "p2",         "p3", "n0", "n1", "n2", "n3" };
      double PAR_GUESSES[NPARS] = { 1E-5,  4976.,   1.0,   1.0, 3.27713e-01, 8.33753e+00, 5.37123e+00,  4.05975e-02,   10,   10,   10,   10 };
      double PAR_MIN[NPARS]     = {    0,    0.0,   0.0,   0.0,       -9999,       -9999,       -9999,        -9999,    9,    9,    9,    9 };
