...
const char* PAR_NAMES[9]    = { "xs", "lumi", "jes", "jer", "eff",  "bkg norm",        "p1",        "p2",         "p3" };
      double PAR_GUESSES[9] = {  0.1,  4976.,   1.0,   1.0,   0.1, 4.11085e-03, 6.37674e+00, 5.58509e+00,  4.91493e-02 };
...
const double PAR_ERR[9]     = { 0.01,   110.,  0.04,  0.10,  0.01,      1e-03,        1e-01,       1e-01,        1e-02 };
