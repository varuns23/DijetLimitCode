...
const char* PAR_NAMES[NPARS]    = { "xs", "lumi", "jes", "jer", "eff",  "bkg norm",        "p1",        "p2",         "p3", "n0", "n1", "n2", "n3" };
      double PAR_GUESSES[NPARS] = {  0.1,  4976.,   1.0,   1.0,   0.5, 6.68340e-03, 5.82157e+00, 6.85018e+00,  2.02493e-01,   10,   10,   10,   10 };
...
int main(int argc, char* argv[])
{
  ...
  // input file names
  INPUTFILES.push_back("Data_and_ResonanceShapes/Final__histograms_TCHEL_0Tag_WideJets.root");
