...
legend.AddEntry(g_comb_0p1, "Combined (f_{b#bar{b}} = 0.1)","lp")
legend.AddEntry(g_comb_1p0, "Combined (f_{b#bar{b}} = 1.0)","lp")
legend.AddEntry(g_incl_0p1, "Inclusive (f_{b#bar{b}} = 0.1)","lp")
legend.AddEntry(g_incl_1p0, "Inclusive (f_{b#bar{b}} = 1.0)","lp")
legend.Draw()
